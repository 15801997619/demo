...
public interface WeatherWebServiceSoap {
     ...
     * @return
     *     returns com.example.demo.free.webservice.client.ArrayOfString
     */
    @WebMethod(action = "http://WebXml.com.cn/getSupportCity")
    @WebResult(name = "getSupportCityResult", targetNamespace = "http://WebXml.com.cn/")
    @RequestWrapper(localName = "getSupportCity", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetSupportCity")
    @ResponseWrapper(localName = "getSupportCityResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetSupportCityResponse")
    ...
    @RequestWrapper(localName = "getSupportProvince", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetSupportProvince")
    @ResponseWrapper(localName = "getSupportProvinceResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetSupportProvinceResponse")
     ...
     * 
     * @return
     *     returns com.example.demo.free.webservice.client.GetSupportDataSetResponse.GetSupportDataSetResult
     */
    ...
    @RequestWrapper(localName = "getSupportDataSet", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetSupportDataSet")
    @ResponseWrapper(localName = "getSupportDataSetResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetSupportDataSetResponse")
    public com.example.demo.free.webservice.client.GetSupportDataSetResponse.GetSupportDataSetResult getSupportDataSet();
    ...
    @RequestWrapper(localName = "getWeatherbyCityName", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetWeatherbyCityName")
    @ResponseWrapper(localName = "getWeatherbyCityNameResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetWeatherbyCityNameResponse")
    ...
    @RequestWrapper(localName = "getWeatherbyCityNamePro", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetWeatherbyCityNamePro")
    @ResponseWrapper(localName = "getWeatherbyCityNameProResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.example.demo.free.webservice.client.GetWeatherbyCityNameProResponse")
